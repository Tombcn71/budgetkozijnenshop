...
const faqsRotterdam = [
  {
    question: "Waarom bieden jullie de beste prijzen voor kozijnen in Rotterdam?",
  ...
  {
    question: "Wat is de levertijd van kozijnen in Rotterdam? Van afspraak tot montage?",
  ...
  {
    question: "Wat zijn de kosten voor kozijnen in een gemiddeld appartement in Rotterdam?",
  ...
  {
    question: "Wat zijn de kosten voor kozijnen in een tussenwoning in Rotterdam?",
  ...
  {
    question: "Wat zijn de kosten voor kozijnen in een hoekwoning in Rotterdam?",
  ...
  {
    question: "Wat zijn de kosten voor kozijnen in een twee-onder-een-kapwoning in Rotterdam?",
  ...
  {
    question: "Wat zijn de kosten voor kozijnen in een vrijstaande woning in Rotterdam?",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Alles wat u moet weten over het vervangen van kozijnen in Rotterdam
            </p>
          </div>

          <div className="space-y-4">
            {faqsRotterdam.map((faq, index) => (
              <div
                key={index}
