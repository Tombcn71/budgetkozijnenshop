    ...
    <>
      ...
      <main>
        <GemeenteHero
          ...
          subtitle="Specialist in hoogbouw woningontruiming in Capelle aan den IJssel. Van torens tot galerijflats – wij kennen alle wijken en werken snel en professioneel."
        />
        <HowItWorks />
